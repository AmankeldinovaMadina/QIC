...
from app.db.models import TransportType, Trip, TripStatus, User
...
async def create_test_trip():
    ...
    async with async_session_factory() as session:
        ...
        if existing_user:
            ...
            test_user = User(id=user_id, username="test_user_for_culture_guide")
        ...
        try:
            ...
            print(
                f"Dates: {test_trip.start_date.date()} to {test_trip.end_date.date()}"
            )
            ...
            print(
                f'  -d \'{{"trip_id": "{trip_id}", "destination": "Tokyo, Japan", "language": "en"}}\''
            )
